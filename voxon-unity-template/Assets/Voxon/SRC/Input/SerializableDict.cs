...
[Serializable]
public class KeyCodeStringPair<TEnum> where TEnum : Enum
{
    public string SearchStr;
    public TEnum KeyCode;

    public KeyCodeStringPair(string searchStr, TEnum keyCode)
    {
        SearchStr = searchStr;
        KeyCode = keyCode;
    }
...
[Serializable]
public class IntKeyCodeStringPairDictionary<TEnum> : SerializableDictionary<int, KeyCodeStringPair<TEnum>> where TEnum : Enum
{
}
