...
namespace Voxon
{
    ...
    public class MeshRegister : Singleton<MeshRegister> {
        ...
        {
            if (VXProcess.Instance.bypassMeshRegister == true) return;
		...
		{
            if (VXProcess.Instance.bypassMeshRegister == true) return null;
        ...
        {
            if (VXProcess.Instance.bypassMeshRegister == true) return false ;
